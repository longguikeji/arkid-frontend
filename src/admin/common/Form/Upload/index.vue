  ...
  <div>
    ...
    <template>
      <div class="uploadItem">
        ...
        <div v-if="state.type === 'video'">
          <el-link :href="state.value" target="_blank" style="padding: 5px">
        ...
        <div v-else-if="state.type === 'xlsx'">
          <el-link :href="state.value" target="_blank" />
        </div>
    ...
    <template>
      ...
      >
        ...
        />
        <!-- image -->
        <div v-else-if="state.type === 'image'" style="display: flex">
          <div
            v-if="imageUrl"
            :style="{
        ...
        <!-- XlsxFile -->
        <div v-else-if="state.type === 'xlsx'" id="excel-file-box">
